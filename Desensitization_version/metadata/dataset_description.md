# OfficeFog v1 with Background

OfficeFog v1 is a controlled five-host office-network dataset for testing robust APT detection under corrupted log integrity.
